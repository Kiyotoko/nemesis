    ...
    public class NemesisDispatchHelper implements DispatchHelper<Corresponding<?>, StatusResponse> {
        ...
        public StatusResponse associated() {
            return StatusResponse.newBuilder()
                    .addAllParties(
                            (Iterable<com.karlz.grpc.game.Party>) (Iterable<?>) Corresponding.transform(parties))
                    .addAllPlayers(
                            (Iterable<com.karlz.grpc.game.Player>) (Iterable<?>) Corresponding.transform(players))
                    .addAllUnits(
                            (Iterable<com.karlz.grpc.game.Unit>) (Iterable<?>) Corresponding.transform(units))
                    .addAllProjectiles(
                            (Iterable<com.karlz.grpc.game.Projectile>) (Iterable<?>) Corresponding
                                    .transform(projectiles))
                    .addAllDestroyed(
                            (Iterable<com.karlz.grpc.entity.Observable>) (Iterable<?>) Corresponding
                                    .transform(destroyed))
                    .build();
        }
